...
-- Données pour la table besoin_sinistre
INSERT INTO besoin_sinistre (id, id_region, id_ville, id_besoin, id_categorie, quantite, id_status_besoin_sinistre) VALUES
	(1, 1, 1, 1, 1, 100, 1),
	(2, 2, 2, 2, 2, 10, 2);
